...
image get_image_from_stream_resize_SM(int w, int h, int c, mat_cv** in_img, int dont_close);
...
void send_detections_cv_v3_SM(detection *dets, int num, float thresh, char **names, image **alphabet, int classes, int ext_output);
